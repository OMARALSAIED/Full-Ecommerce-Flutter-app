        ...
        Center(
          ...
          const SizedBox(height: TSize.spaceBtweenItems,),
            Text(TText.omarSupoort,style: Theme.of(context).textTheme.labelMedium,textAlign: TextAlign.center,),
             const SizedBox(height: TSize.spaceBtwSections,),
             SizedBox(width: double.infinity,child: ElevatedButton(onPressed: (){Get.offAll(SuccessScreen(image: TImage.accepted,title:TText.verificationSuccess ,subtitle: TText.successsubtitle,onPressed: () {
               Get.to(LoginScreen());
